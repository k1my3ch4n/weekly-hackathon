...
const STORAGE_KEY = "aiguru-checklist-v1";

const FLAT_ITEMS = CHECKLIST_GROUPS.flatMap((group) =>
...
export default function Checklist() {
  ...
  const groupStartIndices = CHECKLIST_GROUPS.reduce<number[]>((acc, _group, i) => {
    acc.push(i === 0 ? 0 : acc[i - 1] + CHECKLIST_GROUPS[i - 1].items.length);
    return acc;
  }, []);
